...
| [Питание и калории](NUTRITION.md) | RunBonus+: дневник питания, AI-фото, баланс калорий |
| [**Питание v2.0 — полная спецификация**](NUTRITION_V2_SPEC.md) | Product Spec: 20 разделов, User Stories, API, QA, roadmap |
